...
{
    const char *startup = Py_GETENV("PYTHONSTARTUP");
    if (startup != NULL && startup[0] != '\0') {
        PYFILE *fp = pyfopen(startup, "r");
        if (fp != NULL) {
...
Py_Main(int argc, char **argv)
{
    ...
    stdin_is_interactive = Py_FdIsInteractive(pystdin, (char *)0);
    ...
    if (Py_InspectFlag && stdin_is_interactive &&
        ...
        Py_InspectFlag = 0;
        /* XXX */
        sts = PyRun_AnyFileFlags(pystdin, "<stdin>", &cf) != 0;
    }
