...
typedef int (*printfunc)(PyObject *, PYFILE *, int);
...
PyAPI_FUNC(int) PyObject_Print(PyObject *, PYFILE *, int);
...
PyAPI_FUNC(void) _Py_PrintReferences(PYFILE *);
PyAPI_FUNC(void) _Py_PrintReferenceAddresses(PYFILE *);
