...
node *
PyParser_ParseFile(PYFILE *fp, const char *filename, grammar *g, int start,
...
node *
PyParser_ParseFileFlags(PYFILE *fp, const char *filename, grammar *g, int start,
...
node *
PyParser_ParseFileFlagsEx(PYFILE *fp, const char *filename, grammar *g, int start,
                          char *ps1, char *ps2, perrdetail *err_ret, int *flags)
{
    struct tok_state *tok;
